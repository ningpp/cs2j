...
{
    [Fact]
    public void ConsoleWriteLine_SingleArgument_MapsToSystemOutPrintln()
    {
        const string code = """
            using System;
        ...
        Assert.Contains("System.out.println(s)", result.GeneratedCode);
        Assert.DoesNotContain("Console.writeLine", result.GeneratedCode);
    }
